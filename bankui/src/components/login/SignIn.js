        ...
        <div className="col-md-12 mt-5">
            ...
            <form className="row g-3 mt-5 bg-dark bg-opacity-25" onSubmit={handleSubmit(onSubmit)}>
                <div className="form-group">
                    ...
                    <input type="username" className="form-control" id="inputUsername" placeholder="Enter email"{...register("username", {required:true})} aria-invalid={errors.username ? "true" : "false"}/>
                ...
                <div className="form-group">
                    ...
                    <input type="password" className="form-control" id="inputPassword" placeholder="Password" {...register("password", {required:true})} aria-invalid={errors.password ? "true" : "false"}/>
